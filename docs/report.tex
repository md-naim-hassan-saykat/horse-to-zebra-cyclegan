...
\title{\textbf{Horse-to-Zebra Image Translation Using CycleGAN}}
...
\subsection{Qualitative Results: Horse-to-Zebra}
Figure~\ref{fig:h2z} shows a grid of real horses and their translated zebras produced by the trained model.
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\linewidth]{figs/real_horses.png}
        \caption{Real Horses}
    \end{subfigure}\hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\linewidth]{figs/fake_zebras.png}
        \caption{Generated Zebras}
    \end{subfigure}
    \caption{Qualitative example of horse-to-zebra translation using CycleGAN.}
    \label{fig:h2z}
\end{figure}

\subsection{Qualitative Results: Zebra-to-Horse}
Figure~\ref{fig:z2h} presents real zebras and their translated horses.
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\linewidth]{figs/real_zebras.png}
        \caption{Real Zebras}
    \end{subfigure}\hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\linewidth]{figs/fake_horses.png}
        \caption{Generated Horses}
    \end{subfigure}
    \caption{Qualitative example of zebra-to-horse translation using CycleGAN.}
    \label{fig:z2h}
\end{figure}
